...
class Checker1 {
    static parse(range) {
        ...
        switch(range.substring(0, 2)){
            ...
            case '<=':
                {
                    const emVar1 = EmVar.parse(range.substring(2));
                    return new Checker1((version)=>{
                        const v = EmVar.from(version);
                        return v.lessThanOrEqual(emVar1);
                    });
        ...
        switch(range.substring(0, 1)){
            case '>':
                {
                    console.log('greaterThan');
                    const emVar2 = EmVar.parse(range.substring(1));
                    return new Checker1((version)=>{
                        const v = EmVar.from(version);
                        return v.greaterThan(emVar2);
                    });
            ...
            case '<':
                {
                    const emVar3 = EmVar.parse(range.substring(1));
                    return new Checker1((version)=>{
                        const v = EmVar.from(version);
                        return v.lessThan(emVar3);
                    });
            ...
            case '=':
                {
                    const emVar4 = EmVar.parse(range.substring(1));
                    return new Checker1((version)=>{
                        const v = EmVar.from(version);
                        return v.equals(emVar4);
                    });
...
const migration = mod3.migrations.fromMapping({}, "0.3.1.4");
